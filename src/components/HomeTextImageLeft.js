...
const HomeTextImageLeft = ({
  image = "https://images.unsplash.com/photo-1518611012118-696072aa579a?auto=format&fit=crop&w=600&q=80",
  title = "Resultados Reales, Comunidad Real",
  text = "CatamamaFit no es solo un programa, es una comunidad de mujeres que se apoyan y crecen juntas. Vive la experiencia de transformar tu cuerpo y tu mente con acompañamiento real.",
  cta = "Ver comunidad",
  ctaLink = "/#comunidad"
}) => {
  return (
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-10 md:gap-16">
        <motion.div
          className="w-full md:w-1/2 h-64 md:h-96 rounded-2xl overflow-hidden shadow-xl mb-8 md:mb-0"
          initial="hidden"
          whileInView="visible"
...
export default HomeTextImageLeft;
