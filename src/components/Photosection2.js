...
const Photosection = ({
  image1 = "https://i.imgur.com/HcKtUa0.png",
  image2 = "https://i.imgur.com/9XMuIti.png",
  title = "",
  ...
  return (
    <section className="py-16 bg-primary-dark">
      <h2 className="text-3xl  text-center mb-8 text-white uppercase font-bold">¿Qué incluye el reto?</h2>
